  ...
  <Html lang="pt" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={brand}>Kwendi — Umbundu &amp; Cultura Angolana</Text>
      </Container>
    </Body>
  </Html>
)
...
const logo = { borderRadius: '12px', margin: '0 0 20px' }
...
const brand = { fontSize: '12px', color: '#C4211C', fontWeight: 700 as const, margin: '8px 0 0' }
