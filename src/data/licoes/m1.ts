...
const U1: Licao[] = [
  ...
  },
  {
    ...
    passos: [
      ...
      TUP("Ndakolapo ciwa", ["Estou doente", "Estou bem", "Boa noite"], 1),
      {
        tipo: "emparelhar",
        pares: [
          { umbundu: "Wakolapo?", pt: "Como estás?" },
          { umbundu: "Ndakolapo ciwa", pt: "Estou bem" },
          { umbundu: "Hisepo kamwe", pt: "Mais ou menos" },
          { umbundu: "Ame", pt: "Eu" },
        ],
      },
      {
  ...
  },
  {
    ...
    passos: [
      ...
      {
        tipo: "escuta_montar",
        audio: "Ndakolapo ciwa ndapandula",
        pt: "Estou bem, obrigado",
        alvo: "Ndakolapo ciwa ndapandula",
        distratores: ["Ove", "Kalapo"],
      },
      {
...
const U3: Licao[] = [
  ...
  },
  {
    ...
    passos: [
      ...
      A("Kupemba", "Maio"),
      A("Kavambi", "Junho"),
      A("Evambi-linene", "Julho"),
      A("Kanyenye", "Agosto"),
      A("Enyenye linene", "Setembro"),
      A("Mbala vipembe", "Outubro"),
      A("Kuvala", "Novembro"),
      A("Cembanima", "Dezembro"),
      E("Susu", "Janeiro", ["Janeiro", "Fevereiro", "Março"], 0),
      TPU("Dezembro", ["Cembanima", "Susu", "Kupupu"], 0),
      TUP("Kayovo", ["Janeiro", "Fevereiro", "Março"], 1),
      M("Diz em Umbundu: “Setembro”", "Enyenye linene"),
      W("Escreve em Umbundu: “Abril”", "Kupupu"),
      F("Cembanima", "Dezembro"),
    ],
  },
  {
    id: "m1u3s9",
    titulo: "Onde nasceste?",
    personagens: ["yellen", "hossy"],
    passos: [
      A("Pi acitiwila?", "Onde nasceu?"),
      A("Wacitiwila vongelenge", "Nasceu no Guerengue"),
      A("Wacitiwa vulima upi?", "Em que ano nasceu?"),
      D([
        { p: "yellen", u: "Pi acitiwila, Hossy?", t: "Onde nasceste, Hossy?" },
        { p: "hossy", u: "Wacitiwila vongelenge.", t: "Nasci no Guerengue." },
        { p: "yellen", u: "Wacitiwa vulima upi?", t: "Em que ano nasceste?" },
        { p: "hossy", u: "Wacitiwa vulima wolohulukãyi vivali.", t: "Nasci em 2000." },
      ]),
      E("Pi acitiwila?", "Onde nasceu?", ["Onde vais?", "Onde nasceu?", "Como estás?"], 1),
      TPU("Em que ano nasceu?", ["Wacitiwa vulima upi?", "Pi enda?", "Ciñgami?"], 0),
      M("Traduz: “Nasceu no Guerengue”", "Wacitiwila vongelenge"),
      F("Pi acitiwila?", "Onde nasceu?"),
    ],
  },
];
...
const U4: Licao[] = [
  ...
  {
    id: "m1u4s8",
    titulo: "Comida no mercado",
    personagens: ["laura", "cile"],
    passos: [
      A("Osema", "Fuba"),
      A("Ocipoke", "Feijão"),
      A("Ocitina", "Batata-doce"),
      A("Ombisi", "Peixe"),
      A("Ositu yongombe", "Carne de vaca"),
      A("Ositu yongulu", "Carne de porco"),
      A("Osanji", "Galinha"),
      D([
        { p: "laura", u: "Ombisi yikasi ciñgami?", t: "Quanto é o peixe?" },
        { p: "cile", u: "Akwi avali kolokwanja.", t: "Vinte kwanzas." },
        { p: "laura", u: "Ositu yongombe ciñgami?", t: "E a carne de vaca?" },
        { p: "cile", u: "Akwi akwala kolokwanja.", t: "Quarenta kwanzas." },
      ]),
      E("Ocipoke", "Feijão", ["Fuba", "Feijão", "Batata-doce"], 1),
      TPU("Carne de vaca", ["Ositu yongombe", "Ositu yongulu", "Osanji"], 0),
      TUP("Ombisi", ["Galinha", "Peixe", "Feijão"], 1),
      M("Monta: “Quanto é o peixe?”", "Ombisi yikasi ciñgami"),
      F("Osema yikasi ciñgami?", "Quanto é a fuba?"),
    ],
  },
  {
    id: "m1u4s9",
    titulo: "Bebida e cozinha",
    personagens: ["yellen", "hossy"],
    passos: [
      A("Ovava", "Água"),
      A("Ovava okunywa", "Água para beber"),
      A("Ovava vatokota", "A água está quente"),
      A("Ovava vatalala", "A água está fria"),
      A("Okunywa", "Beber"),
      A("Okukanga", "Fritar"),
      A("Ulela", "Óleo"),
      A("Usole", "Molho"),
      D([
        { p: "yellen", u: "Ndayongwile okunywa ovava.", t: "Queria água para beber." },
        { p: "hossy", u: "Ovava vatokota.", t: "A água está quente." },
        { p: "yellen", u: "Ovava vatalala?", t: "A água está fria?" },
      ]),
      E("Ovava vatokota", "A água está quente", ["A água está fria", "A água está quente", "Não há água"], 1),
      TPU("Óleo", ["Ulela", "Usole", "Owiki"], 0),
      TUP("Okukanga", ["Cozinhar", "Fritar", "Comer"], 1),
      M("Monta: “Queria água para beber”", "Ndayongwile okunywa ovava"),
      F("Ovava vatalala", "A água está fria"),
    ],
  },
];
...
const U5: Licao[] = [
  ...
  },
  {
    ...
    passos: [
      A("Ukãyi", "Mulher / esposa"),
      A("Ulume", "Homem / marido"),
      A("Ukãyi wange", "Minha mulher"),
      A("Ulume wange", "Meu marido"),
      A("Manjange", "Meu irmão"),
      A("Epalume lyange", "Meu primo"),
      A("Ndatembo yange", "Meu sogro(a)"),
      A("Nekulu yange", "Meu neto"),
      D([
        { p: "kwendi", u: "U ukãyi wange.", t: "Esta é minha mulher." },
        { p: "otchali", u: "U ulume wange.", t: "Este é meu marido." },
        { p: "kwendi", u: "Manjange lokwete Epalume lyange.", t: "O meu irmão e o meu primo." },
      ]),
      E("Ukãyi wange", "Minha mulher", ["Meu marido", "Minha mulher", "Meu irmão"], 1),
      TPU("Meu neto", ["Nekulu yange", "Ndatembo yange", "Manjange"], 0),
      TUP("Epalume lyange", ["Meu tio", "Meu primo", "Meu sogro"], 1),
      M("Monta: “Este é meu marido”", "U ulume wange"),
      F("Ndatembo yange", "Meu sogro"),
    ],
  },
  {
    id: "m1u5s18",
    ...
    passos: [
      ...
      A("Okulu", "Perna"),
      A("Ongolo", "Joelho"),
      E("Isso", "Olho", ["Boca", "Olho", "Nariz"], 1),
      TPU("Coração", ["Utima", "Etimba", "Utwe"], 0),
      TUP("Okulu", ["Braço", "Perna", "Cabeça"], 1),
      M("Diz em Umbundu: “Boca”", "Omelã"),
      W("Escreve: “Cabeça”", "Utwe"),
      F("Utima", "Coração"),
    ],
  },
  {
    ...
    passos: [
      A("Olupale", "Cidade"),
      A("Okololo", "Rua"),
      A("Ocitanda", "Praça / mercado"),
      A("Yimbo", "Aldeia"),
      A("Osanjala", "Bairro"),
      A("Vokati kolupale", "Dentro da cidade"),
      A("Uti", "Árvore"),
      A("Ombela", "Chuva"),
      A("Owyã", "Calor"),
      A("Ombambi", "Frio"),
      D([
        { p: "yellen", u: "Ndenda kolupale.", t: "Vou à cidade." },
        { p: "hossy", u: "Ombela yikasi.", t: "Está a chover." },
        { p: "yellen", u: "Ombambi calwa!", t: "Que frio!" },
      ]),
      E("Ombela", "Chuva", ["Sol", "Chuva", "Vento"], 1),
      TPU("Aldeia", ["Yimbo", "Olupale", "Ocitanda"], 0),
      TUP("Owyã", ["Frio", "Calor", "Chuva"], 1),
      M("Traduz: “Dentro da cidade”", "Vokati kolupale"),
      F("Ombela yikasi", "Está a chover"),
    ],
  },
];
