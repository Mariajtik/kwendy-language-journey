...
export const CURRICULO: Modulo[] = [
  {
    ...
    unidades: [
      ...
      },
      {
        ...
        seccoes: mk("m1u5", [
          "Vogais — a, e, i, o, u",
          "Consoantes I — b, c, d, f, g",
          "Consoantes II — h, j, k, l",
          "Consoantes III — m, n, p, s",
          "Consoantes IV — t, v, w, y",
          "Digrafos nasais — mb, nd, ng, ny",
          "Tabela do alfabeto Umbundu",
          "Letras que não existem — q, r, x, z",
          "Vogais nasais — ã, õ",
          "Revisão do alfabeto",
