...
export const CURRICULO: Modulo[] = [
  {
    ...
    unidades: [
      ...
      },
      {
        ...
        cor: "25 90% 55%",
        seccoes: mk("m1u2", ["Pai e mãe", "Irmãos", "Em casa"]),
      },
      {
        id: "m1u3",
        numero: 3,
        titulo: "Números & numerais",
        cor: "35 90% 50%",
        seccoes: mk("m1u3", ["Números 0–10", "Números 11–20", "Dezenas e centenas", "Contar objetos"]),
      },
      {
        id: "m1u4",
        numero: 4,
        ...
        cor: "200 75% 45%",
        seccoes: mk("m1u4", ["Dias úteis", "Fim-de-semana", "Hoje, ontem, amanhã"]),
      },
      {
        id: "m1u5",
        numero: 5,
        titulo: "Meses do ano",
        cor: "265 60% 55%",
        seccoes: mk("m1u5", ["Janeiro a Junho", "Julho a Dezembro", "Datas do dia-a-dia"]),
      },
      {
        id: "m1u6",
        numero: 6,
        ...
        cor: "150 60% 40%",
        seccoes: mk("m1u6", ["Cacimbo (seca)", "Calor & chuvas", "Falar do tempo"]),
      },
      {
        id: "m1u7",
        numero: 7,
        ...
        cor: "330 75% 55%",
        seccoes: mk("m1u7", ["Rosto e cabeça", "Tronco e membros", "No médico"]),
      },
      {
        id: "m1u8",
        numero: 8,
        ...
        cor: "5 84% 50%",
        seccoes: mk("m1u8", ["Diálogos do dia-a-dia", "Perguntar e responder", "Praticar"]),
      },
    ],
  },
  {
