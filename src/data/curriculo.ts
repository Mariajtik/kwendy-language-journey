    ...
    unidades: [
      {
        ...
        cor: "5 84% 42%",
        seccoes: mk("m1u1", ["Como te chamas?", "Quem sou eu", "Como estás?", "Apresentar-me em poucas frases"]),
      },
      {
        id: "m1u2",
        numero: 2,
        titulo: "De manhã",
        cor: "25 90% 55%",
        seccoes: mk("m1u2", ["Wakolelepo · bom dia", "Saudar os mais-velhos", "Como passaste a noite?", "Responder à saudação"]),
      },
      {
        id: "m1u3",
        numero: 3,
        titulo: "Na rua",
        cor: "35 90% 50%",
        seccoes: mk("m1u3", ["Para onde vais?", "De onde vens?", "Quantos anos tens?", "Cumprimentar conhecidos"]),
      },
      {
        id: "m1u4",
        numero: 4,
        titulo: "No mercado",
        cor: "200 75% 45%",
        seccoes: mk("m1u4", ["Quanto é?", "Quero comprar…", "Números 1–10", "Agradecer e despedir"]),
      },
      {
        id: "m1u5",
        numero: 5,
        titulo: "Conversação",
        cor: "330 75% 55%",
        seccoes: mk("m1u5", ["Diálogo de manhã", "Diálogo na rua", "Diálogo no mercado", "Juntar tudo"]),
      },
    ],
  },
  {
    ...
    unidades: [
      {
        id: "m2u1",
        numero: 1,
        titulo: "Perguntas simples",
        cor: "5 84% 42%",
        seccoes: mk("m2u1", ["Quem, o quê, onde", "Quando e porquê", "Praticar perguntas"]),
      },
      {
        id: "m2u2",
        numero: 2,
        ...
        cor: "265 60% 55%",
        seccoes: mk("m2u2", ["Ee · sim / Tate · não", "Ndapandula · obrigado", "Por favor e perdão"]),
      },
      {
        id: "m2u3",
        numero: 3,
        titulo: "Saudar mais-velhos",
        cor: "200 75% 45%",
        seccoes: mk("m2u3", ["Formas respeitosas", "Despedidas", "Cortesia no diálogo"]),
      },
      {
        id: "m2u4",
        numero: 4,
        titulo: "Pequenos diálogos",
        cor: "150 60% 40%",
        seccoes: mk("m2u4", ["Encontrar um amigo", "Pedir uma informação", "Diálogo completo"]),
      },
    ],
  },
  {
    ...
    unidades: [
      {
        id: "m9u1",
        numero: 1,
        titulo: "Compartimentos e mobília",
        cor: "178 60% 42%",
        seccoes: mk("m9u1", ["Compartimentos da casa", "Mobília", "Onde vivo"]),
      },
      {
        id: "m9u2",
        numero: 2,
        ...
        cor: "265 55% 52%",
        seccoes: mk("m9u2", ["Loiça", "Utensílios da cozinha", "Praticar"]),
      },
      {
        id: "m9u3",
        numero: 3,
        titulo: "Vestuário",
        cor: "25 85% 52%",
        seccoes: mk("m9u3", ["Roupa do dia-a-dia", "Roupa tradicional", "Conversação"]),
      },
      {
        id: "m9u4",
        numero: 4,
        titulo: "Alimentação",
        cor: "150 55% 40%",
        seccoes: mk("m9u4", ["Comidas típicas", "Bebidas", "À mesa"]),
      },
    ],
  },
  {
    ...
    unidades: [
      {
        ...
        cor: "5 84% 42%",
        seccoes: mk("m11u1", ["Advérbios de modo", "Pi · onde / Kupi · aonde", "Conversação"]),
      },
      {
        id: "m11u2",
        numero: 2,
        ...
        cor: "200 75% 45%",
        seccoes: mk("m11u2", ["Tempo e quantidade", "Dúvida", "Negação"]),
      },
      {
        id: "m11u3",
        numero: 3,
        ...
        cor: "150 60% 40%",
        seccoes: mk("m11u3", ["Copulativas e disjuntivas", "Adversativas e conclusivas", "Conversação"]),
      },
      {
        id: "m11u4",
        numero: 4,
        ...
        cor: "210 75% 50%",
        seccoes: mk("m11u4", ["Causais e condicionais", "Temporais e concessivas", "Comparativas"]),
      },
    ],
  },
  {
